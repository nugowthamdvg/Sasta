package com.SastaSundar.genericLib;
...
//		if(browservar.equals("chrome")) //for cross browser action
		...
		{
			System.setProperty("webdriver.chrome.driver","E:\\selenium\\SastaSundar\\browsers\\chromedriver.exe");
...
//		else if(browservar.equals("firefox")) //for cross browser action
		...
		{
			System.setProperty("webdriver.gecko.driver","E:\\selenium\\SastaSundar\\browsers\\geckodriver.exe");
