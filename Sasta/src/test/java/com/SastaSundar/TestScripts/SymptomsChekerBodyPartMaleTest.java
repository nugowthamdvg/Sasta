...
public class SymptomsChekerBodyPartMaleTest extends Base 
{	
	...
	{
		return fl.getAllDataFromExcelFile("BPMale");
	}
	@Test(dataProvider = "readData")
	public void bodyPartMaleTest(String BodyPart,String Symptom1,String Symptom2,
...
//		Reporter.log("clicked on body parts link",true);
		...
		Reporter.log("selected symptom",true);
