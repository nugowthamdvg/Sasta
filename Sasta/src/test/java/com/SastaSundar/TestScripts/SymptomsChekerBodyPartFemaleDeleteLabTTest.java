...
public class SymptomsChekerBodyPartFemaleDeleteLabTTest extends Base
{
	...
	{
		return fl.getAllDataFromExcelFile("BPFemaleDelete");
	}
	...
	public void bodyPartFemaleTest(String BodyPart,String Symptom1,String Symptom2,String Symptom3,String Symptom4,String Symptom5,
			String Symptom6,String Diseases,
			String LabTest,String DiagonosticCenter,String AppointmentTime,String LabTestPage) throws Exception
	{
...
//		driver.findElement(By.xpath("//div[@class='button-right']/a[@class='btn btn-default']/strong")).click();
		...
		Reporter.log("selected the DiagonosticCenter-->"+DiagonosticCenter,true);
		Thread.sleep(4000);
