...
public class SymptomsChekerInternalOrgansMaleTest extends Base 
{
	...
	{
		return fl.getAllDataFromExcelFile("IOMale");
	}
	@Test(dataProvider = "readData")
	public void internalOrgansFemaleTest(String Symptoms,String Diseases,String ReadMore,
			String Header,String LabTest,String AppointmentDate,String AppointmentTime) throws Exception
	{
		...
		Reporter.log("slecected symptom-->"+Symptoms,true);
