...
public class OrderMedicine_AddToCartTest extends Base
{
	...
	public void addToCartMedicineTest(String med) throws Exception
	{
		...
		String actul1 = driver.findElement(By.xpath("//a[contains(text(),'"+med+" ')]")).getText();
		System.out.println(actul1);
		Assert.assertTrue(actul1.contains(""+med+""));
		Reporter.log("medicine added to cart successfully",true);
